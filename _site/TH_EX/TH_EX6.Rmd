...
Due to too many variable of age and joviality, we will group them into 8 tiles. 1st tile represents the lowest value and increase thereafter. 
...
```{r}
Low_to_drop <- c("age", "joviality")

participant_nodes <- participant_nodes[, !(names(participant_nodes) %in% Low_to_drop)]
```

To further reduce the data size, we will drop the participant under age tile 1. 
